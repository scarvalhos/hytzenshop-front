...
router.post('/register', (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { username, email, password, avatar, isAdmin, userData } =
      request.body
    let userAddressId
    try {
      const user =
        (yield prismaClient_1.prismaClient.user.findUnique({
          where: { username },
        })) ||
        (yield prismaClient_1.prismaClient.user.findUnique({
          where: { email },
      ...
      if (
        userData === null || userData === void 0 ? void 0 : userData.address
      ) {
        yield (0, auth_2.validateUserAddress)(
          Object.assign(
            {},
            userData === null || userData === void 0 ? void 0 : userData.address
          )
      ...
      const userDataId =
        ...
        (yield prismaClient_1.prismaClient.userData.create({
          data: {
            ...
            cpf:
              userData === null || userData === void 0 ? void 0 : userData.cpf,
            phone:
              userData === null || userData === void 0
                ? void 0
                : userData.phone,
            userAddressId:
              (userAddressId === null || userAddressId === void 0
                ? void 0
                : userAddressId.id) || undefined,
          },
        }))
...
router.post('/login', (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      return response
        .status(200)
        .json(Object.assign(Object.assign({}, user), { accessToken }))
    } catch (error) {
      return response.status(500).json(error)
    }
  })
...
// Me
router.get('/me', verifyToken_1.verifyToken, (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let _a = request.body,
      { user } = _a,
      rest = __rest(_a, ['user'])
...
router.post('/reset-password', (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      user.password = crypto_js_1.default.AES.encrypt(
        password,
        hash_1.hash
      ).toString()
      ...
      return res
        .status(200)
        .send({ message: 'Nova senha definida com sucesso!' })
    } catch (err) {
