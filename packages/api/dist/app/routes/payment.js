...
router.post('/payment', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (method === 'boleto') {
        try {
            const res = yield (0, cross_fetch_1.default)('https://api.mercadopago.com/v1/payments', {
                method: 'POST',
                headers: {
...
router.post('/payment/webhooks', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (topic === 'payment') {
            const payment = yield mercadopago_1.default.payment.findById(id);
            const mpResponse = yield (0, cross_fetch_1.default)(`https://api.mercadopago.com/v1/payments/${id}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
