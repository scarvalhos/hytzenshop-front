...
// Create Order
router.post('/', verifyToken_1.verifyToken, (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const _a = request.body,
      { user } = _a,
      payload = __rest(_a, ['user'])
    try {
...
// Update Order
router.put('/:id', verifyToken_1.verifyTokenAndAdmin, (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
// User Update Order
router.patch('/:id/:status', verifyToken_1.verifyToken, (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
// Get Monthly Income
router.get('/income', verifyToken_1.verifyTokenAndAdmin, (_request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const date = new Date()
