...
router.get('/', verifyToken_1.verifyTokenAndAdmin, pagination_1.pagination, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/stats', verifyToken_1.verifyTokenAndAdmin, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const previousMonth = new Date(new Date().setMonth(lastMonth.getMonth() - counter));
    try {
    ...
    try {
        ...
        if (address) {
            updatedUser = yield prismaClient_1.prismaClient.userAddress.update({
                where: { id: ((_a = user === null || user === void 0 ? void 0 : user.userData) === null || _a === void 0 ? void 0 : _a.userAddressId) || '' },
                data: Object.assign({}, address),
            });
        }
        if (userData) {
            updatedUser = yield prismaClient_1.prismaClient.userData.update({
                where: { id: (user === null || user === void 0 ? void 0 : user.userDataId) || '' },
