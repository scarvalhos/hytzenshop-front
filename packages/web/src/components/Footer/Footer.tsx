...
import { c, defaultToastError } from '@utils/helpers'
...
const Footer: React.FC = () => {
  ...
  return (
    <GlassContainer
      className={c(
        'gap-8 flex px-8 sm:px-16 py-10 mt-10',
    ...
    >
      ...
      <button
        className="bg-dark-gray-400 fixed bottom-8 right-8 p-2 rounded-md z-[9999999] transition-all"
        onClick={() => {
