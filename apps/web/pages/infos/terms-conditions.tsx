...
const TermsAndConditionsPage: NextPage = () => {
  return (
    <HeaderFooterLayout glassEffect={false}>
      <NextSeo title="Termos e condições" />

      <InfosLayout>
        <h1 className="text-light-gray-100 text-2xl">Termos e condições</h1>

        <p>Esta política de Termos de Uso é válida a partir de Dec 2022.</p>

        <p className="text-light-gray-100 text-body-md">
          TERMOS DE USO — Hytzen Shop
        </p>

        <p>
          Hytzen Shop, pessoa jurídica de direito privado descreve, através
          deste documento, as regras de uso do site https://www.shop.hytzen.com
          e qualquer outro site, loja ou aplicativo operado pelo proprietário.
        </p>
        <p>
        ...
        <p className="text-light-gray-100 text-body-md">Seção 1 - Usuário</p>
        ...
        <p>
          ...
          Uso e a versão mais atualizada da Política de Privacidade de Hytzen
          Shop.
        </p>
        ...
        <p>
          Em geral, o acesso ao website da Hytzen Shop possui caráter gratuito e
        ...
        <p>
          ...
          comentários em determinadas áreas. Hytzen Shop não consente com a
        ...
        <p>
          ...
          publicação pela Hytzen Shop no seu website, plataformas e aplicações
          de internet, ou ainda em outras plataformas, sem qualquer restrição ou
          limitação.
        </p>

        <p className="text-light-gray-100 text-body-md">Seção 4 - Cookies</p>
        ...
        <p>
          Todos os elementos de Hytzen Shop são de propriedade intelectual da
          ...
          propriedade intelectual da Hytzen Shop ou de terceiros.
        </p>
        ...
        <p>
          ...
          suspenso ou interrompido unilateralmente por Hytzen Shop, a qualquer
        ...
        <p>
          ...
          coletados e tratados por Hytzen Shop e/ou pelos Parceiros. As regras
          relacionadas ao tratamento de dados pessoais de Hytzen Shop estão
          estipuladas na Política de Privacidade.
        </p>

        <p className="text-light-gray-100 text-body-md">Seção 9 - Contato</p>

        <p>
          Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor,
          entre em contato pelo e-mail adm@hytzen.com.
        </p>
      </InfosLayout>
    </HeaderFooterLayout>
  )
