...
const PrivacyPolicyPage: NextPage = () => {
  return (
    <HeaderFooterLayout glassEffect={false}>
      <NextSeo title="Política de privacidade" />

      <InfosLayout>
        <h1 className="text-light-gray-100 text-2xl">
          Política de Privacidade
        </h1>

        <p>Esta política é válida a partir de Dec 2022.</p>

        <p>Política de Privacidade - Hytzen Shop</p>

        <p>
          Hytzen Shop, pessoa jurídica de direito privado leva a sua privacidade
          ...
          https://www.shop.hytzen.com e qualquer outro site, loja ou aplicativo
        ...
        <p>
          ...
          entre em contato com adm@hytzen.com.
        </p>
        ...
        <p className="text-light-gray-100 text-body-md">Seção 1 - Definições</p>
        ...
        <p>
          ...
          relação a uma pessoa natural, origem racial ou étnica, convicção
        ...
        <p>
          Tratamento de Dados Pessoais: significa qualquer operação efetuada no
          âmbito dos Dados Pessoais, por meio de meios automáticos ou não, tal
          como a recolha, gravação, organização, estruturação, armazenamento,
          adaptação ou alteração, recuperação, consulta, utilização, divulgação
          por transmissão, disseminação ou, alternativamente, disponibilização,
          harmonização ou associação, restrição, eliminação ou destruição.
          Também é considerado Tratamento de Dados Pessoais qualquer outra
          operação prevista nos termos da legislação aplicável;
        </p>
        <p>
          Leis de Proteção de Dados: significa todas as disposições legais que
          regulam o Tratamento de Dados Pessoais, incluindo, porém sem se
          limitar, a Lei nº 13.709/18, Lei Geral de Proteção de Dados Pessoais
          (LGPD).
        </p>
        ...
        <p>Viabilizar que você adquira produtos e/ou serviços na loja;</p>
        ...
        <p>Para personalizar sua experiência de uso da loja;</p>
        <p>
          Para entrarmos em contato por um número de telefone e/ou endereço de
          e-mail fornecido. Podemos entrar em contato com você pessoalmente, por
          mensagem de voz, através de equipamentos de discagem automática, por
          mensagens de texto (SMS), por e-mail, ou por qualquer outro meio de
          comunicação que seu dispositivo seja capaz de receber, nos termos da
          lei e para fins comerciais razoáveis.
        </p>
        <p>
          Além disso, os Dados Pessoais fornecidos também podem ser utilizados
          na forma que julgarmos necessária ou adequada: (a) nos termos das Leis
          de Proteção de Dados; (b) para atender exigências de processo
          judicial; (c) para cumprir decisão judicial, decisão regulatória ou
          decisão de autoridades competentes, incluindo autoridades fora do país
          de residência; (d) para aplicar nossos Termos e Condições de Uso; (e)
          para proteger nossas operações; (f) para proteger direitos,
          privacidade, segurança nossos, seus ou de terceiros; (g) para detectar
          e prevenir fraude; (h) permitir-nos usar as ações disponíveis ou
          limitar danos que venhamos a sofrer; e (i) de outros modos permitidos
          por lei.
        </p>
        ...
        <p>
          ...
          informações anônimas e agregadas sobre como a loja é usufruída.
        ...
        <p>
          ...
          dispositivo; dados de uso da Loja; e informações coletadas por meio de
          cookies, pixel tags e outras tecnologias. Nós não coletamos Dados
          Pessoais Sensíveis.
        </p>
        ...
        <p>Com terceiros, com o objetivo de nos ajudar a gerenciar a loja;</p>

        <p>
          Com terceiros, caso ocorra qualquer reorganização, fusão, venda, joint
        ...
        <p>
          ...
          assegurar que a loja funcione adequadamente.
        </p>
        <p>
          ...
          eficiente, e personalizar sua experiência ao utilizar a loja, assim
          como para rastreamento online. Também coletamos informações
          estatísticas sobre o uso da loja para aprimoramento contínuo do nosso
          design e funcionalidade, para entender como a loja é utilizada e para
          auxiliá-lo a solucionar questões relativas à loja.
        </p>
        ...
        <p>
          ...
          e-mails), medir o sucesso das nossas campanhas de marketing e coletar
          dados estatísticos sobre o uso da loja e taxas de resposta, e ainda
          para outros fins não especificados. Podemos contratar empresas de
          publicidade comportamental, para obter relatórios sobre os anúncios da
          loja em toda a internet. Para isso, essas empresas utilizam cookies,
          pixel tags e outras tecnologias para coletar informações sobre a sua
          utilização, ou sobre a utilização de outros usuários, da nossa loja e
          de site de terceiros. Nós não somos responsáveis por pixel tags,
